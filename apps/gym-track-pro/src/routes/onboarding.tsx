...
const goals: { value: Goal; label: string; sub: string; emoji: string }[] = [
  { value: 'lose_weight', label: 'Perder peso', sub: 'Déficit calórico', emoji: '🔥' },
  { value: 'gain_muscle', label: 'Ganar músculo', sub: 'Superávit calórico', emoji: '💪' },
  { value: 'maintain', label: 'Mantenerme', sub: 'Balance calórico', emoji: '⚖️' },
]
...
const OnboardingPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!goal) { setError('Seleccioná un objetivo'); return }
    setError(null)
    setSubmitting(true)
  ...
  return (
    <div className='min-h-screen bg-background'>
      <div className='px-5 pb-10 pt-14'>
        ...
        <h1 className='text-[22px] font-bold text-foreground'>Tu perfil físico</h1>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
          ...
          <div className='flex gap-3'>
            <div className='flex-1'>
              <label className='mb-1.5 block text-xs font-medium text-muted'>Altura (cm)</label>
              <input
                className={inputCls}
                type='number'
                placeholder='175'
            ...
            <div className='flex-1'>
              <label className='mb-1.5 block text-xs font-medium text-muted'>Peso (kg)</label>
              <input
                className={inputCls}
                type='number'
                placeholder='78'
                ...
                return (
                  ...
                  >
                    ...
                    <div className='flex-1'>
                      ...
                      <p className={cn('text-[11px]', active ? 'text-primary/70' : 'text-muted')}>
                        {g.sub}
                      </p>
                    </div>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? 'border-2 border-primary bg-primary-light font-bold text-primary'
