  ...
  return (
    <div className='flex min-h-screen flex-col bg-background'>
      ...
      <div className='flex flex-1 flex-col items-center justify-center px-6 pt-10'>
        ...
        <div className='font-display text-[36px] leading-none text-foreground'>GymTrack</div>
        <div className='font-display text-[36px] leading-none text-primary mb-8'>Pro</div>
        ...
        <div className='w-full max-w-sm'>
          ...
          <div className='my-5 flex items-center gap-3'>
            ...
            <span className='text-xs text-soft'>o continuar con</span>
            <div className='h-px flex-1 bg-border' />
          </div>
