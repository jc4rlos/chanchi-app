...
export const SplashScreen = () => {
  ...
  return (
    <div className='fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#0a0a0a]'>
      ...
      {/* Wordmark */}
      <p className='font-display text-[44px] leading-none text-foreground'>GymTrack</p>
      <p className='font-display mb-2.5 text-[44px] leading-none text-primary'>Pro</p>
      ...
      {/* Version */}
      <p className='absolute bottom-9 text-[11px] text-[#2a2a2a]'>v2.0.0 · PWA</p>
    </div>
  )
}
