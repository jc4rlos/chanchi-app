...
export const RegisterForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <div>
        <label className='mb-1.5 block text-xs font-medium text-muted'>Correo electrónico</label>
        <input
          className={inputCls}
          type='email'
      ...
      {/* Gender selector */}
      <div>
        <label className='mb-2.5 block text-xs font-medium text-muted'>Género</label>
      ...
      <p className='pb-2 text-center text-xs text-soft'>
