...
import { ExerciseFilterMenu } from './exercise-filter-menu'
import { ExerciseFilterTabs } from './exercise-filter-tabs'
import { ExerciseFilterGrid } from './exercise-filter-grid'
import type { FilterMenuOption } from './exercise-filter-menu'
import type { TabOption } from './exercise-filter-tabs'
import type { GridFilterOption } from './exercise-filter-grid'
...
export const ExerciseFilterShowcase = () => {
  ...
  return (
    <div className='space-y-8 p-5'>
      <div>
        <h2 className='mb-3 text-[16px] font-bold'>Menú tipo PILLS (horizontal deslizable)</h2>
        <p className='mb-2 text-[12px] text-muted'>Ideal para filtros simples en espacios pequeños</p>
        <div className='rounded-[12px] bg-card p-2 border border-border'>
          <ExerciseFilterMenu
      ...
      <div>
        ...
        <p className='mb-2 text-[12px] text-muted'>Alternativa minimalista con badges de cantidad</p>
      ...
      <div>
        ...
        <p className='mb-2 text-[12px] text-muted'>Multi-select con iconos, permite filtrar múltiples categorías</p>
        <div className='rounded-[12px] bg-card p-2 border border-border'>
          <ExerciseFilterGrid
      ...
      <div className='rounded-[12px] bg-primary-light border border-[#2a4a1a] p-4'>
        <h3 className='mb-2 text-[13px] font-bold text-primary'>Recomendación</h3>
        <p className='text-[12px] text-[#4a7a4a] leading-relaxed'>
          Para Pantalla 9 (Catálogo de Ejercicios) uso <strong>Pills</strong> (mejor UX móvil, intuitivo,
          deslizable). Alternativas: Tabs si quieres mostrar cantidad, o Grid si permites multi-selección.
        </p>
      </div>
    </div>
  )
